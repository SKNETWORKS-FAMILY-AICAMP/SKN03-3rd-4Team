...
def preprocess_lstm():
    ...
    X_test = sequences_padded_shuffled[split_index:]
    y_test = labels_shuffled[split_index:]
    ...
    return X_train, X_test, y_train, y_test, n_features, max_seq_length, class_weight_dict
