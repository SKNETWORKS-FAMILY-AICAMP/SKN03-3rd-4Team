...
- 현재는 **RandomForest** 모델을 사용하고 있지만, 다른 머신러닝 모델로도 쉽게 확장할 수 있습니다.
- **SHAP** 분석 외에도 다양한 해석 방법을 추가해 모델의 성능 및 결과 해석력을 높일 수 있습니다.

---

이 README는 프로젝트의 코드 구조와 주요 흐름을 이해하는 데 도움을 주며, 머신러닝 모델의 학습, 평가, 저장 과정에 대한 설명을 제공합니다.
